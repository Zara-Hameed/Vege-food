    ...
    <section className="px-4 md:px-20 py-20 bg-white">
      ...
      <div className="overflow-x-auto scrollbar-hide"  data-aos="fade-up">
        <div className="min-w-[700px]">
          {/* Header Row */}
          <div className="grid grid-cols-[50px_100px_1fr_100px_120px_100px] text-center font-semibold bg-primary text-white py-6">
            <div></div>
          ...
          {cartItems.map((item) => (
            <div
              key={item.id}
              className="grid grid-cols-[50px_100px_1fr_100px_120px_100px] text-center items-center  last:border-b-0 py-4"  data-aos="fade-up"
            >
              {/* Remove button */}
